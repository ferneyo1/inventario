<?php
class Almacenamiento extends Controller {
	...
	$this->view->page=1;
	$limite="1000000";
	$this->view->totalList=$this->model->anyList("almacenamiento",$limite);
	...
	$this->view->almacenamientoList = $this->model->almacenamientoList($start,NUM_ITEMS_BY_PAGE);
	$this->view->render("almacenamiento/index");
	}
	...
	$this->view->almacenamientoList = $this->model->almacenamientoListUltimo();
	$this->view->render("almacenamiento/index");
	}
	public function add(){
	$limite=10;
	$start=0;
	$this->view->anyList=$this->model->anyList("almacenamiento",$limite);
	$this->view->almacenamientoList = $this->model->almacenamientoList($start,NUM_ITEMS_BY_PAGE);
	$this->view->almacenamientoListUltimo = $this->model->almacenamientoListUltimo();
	$this->view->render("almacenamiento/add");
	}
	public function search(){
	$start=0;
	$this->view->page=1;
	$this->view->almacenamientoList = $this->model->almacenamientoSingleSearch($_POST["dato"],$_POST["criterio"]);
	$this->view->total_registros=count($this->view->almacenamientoList );
	$this->view->total_pages=ceil($this->view->total_registros/NUM_ITEMS_BY_PAGE);
	$this->view->render("almacenamiento/index");
	}
	...
	$limite=10;
	$this->view->anyList=$this->model->anyList("almacenamiento",$limite);
	$this->view->almacenamientoList = $this->model->almacenamientoSingleList($id);
	$this->view->render("almacenamiento/view");
	}
    public function edit($id){
		$limite=10;
		$this->view->anyList=$this->model->anyList("almacenamiento",$limite);
		$this->view->almacenamientoList = $this->model->almacenamientoSingleList($id);
		$this->view->render("almacenamiento/edit");
	...
	public function copy($id){
		...
		$this->view->anyList=$this->model->anyList("almacenamiento",$limite);
		$this->view->almacenamientoList = $this->model->almacenamientoSingleList($id);
		$this->view->render("almacenamiento/copy");
	...
	//salida de datos como una tabla
        ...
        //header("location: " . URL . "almacenamiento/add");
}
public function editSave($id){
    ...
    header("location: " . URL . "almacenamiento");
}
	...
	public function roles($rol,$id,$opcion){
		switch($rol){
			case 1:
				...
				return "
				<a href=".URL."almacenamiento/copy/$id>
					<i class='fa fa-repeat'title=Copiar></i>
				</a>&nbsp;
				<a href=".URL."almacenamiento/view/$id>
					<i class='fa fa-eye'title=Ver ></i>
				</a>&nbsp;
				<a href=".URL."almacenamiento/edit/$id>
					<i class='fa fa-edit'title=Editar ></i>
				</a>&nbsp;
				<a href=".URL."almacenamiento/delete/$id  id=erase>
