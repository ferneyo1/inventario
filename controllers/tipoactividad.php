<?php
class Tipoactividad extends Controller {
	...
	$this->view->page=1;
	$limite="1000000";
	$this->view->totalList=$this->model->anyList("tipoactividad",$limite);
	...
	$this->view->tipoactividadList = $this->model->tipoactividadList($start,NUM_ITEMS_BY_PAGE);
	$this->view->render("tipoactividad/index");
	}
	...
	$this->view->tipoactividadList = $this->model->tipoactividadListUltimo();
	$this->view->render("tipoactividad/index");
	}
	public function add(){
	$limite=10;
	$start=0;
	$this->view->anyList=$this->model->anyList("tipoactividad",$limite);
	$this->view->tipoactividadList = $this->model->tipoactividadList($start,NUM_ITEMS_BY_PAGE);
	$this->view->tipoactividadListUltimo = $this->model->tipoactividadListUltimo();
	$this->view->render("tipoactividad/add");
	}
	public function search(){
	$start=0;
	$this->view->page=1;
	$this->view->tipoactividadList = $this->model->tipoactividadSingleSearch($_POST["dato"],$_POST["criterio"]);
	$this->view->total_registros=count($this->view->tipoactividadList );
	$this->view->total_pages=ceil($this->view->total_registros/NUM_ITEMS_BY_PAGE);
	$this->view->render("tipoactividad/index");
	}
	...
	$limite=10;
	$this->view->anyList=$this->model->anyList("tipoactividad",$limite);
	$this->view->tipoactividadList = $this->model->tipoactividadSingleList($id);
	$this->view->render("tipoactividad/view");
	}
    public function edit($id){
		$limite=10;
		$this->view->anyList=$this->model->anyList("tipoactividad",$limite);
		$this->view->tipoactividadList = $this->model->tipoactividadSingleList($id);
		$this->view->render("tipoactividad/edit");
	...
	public function copy($id){
		...
		$this->view->anyList=$this->model->anyList("tipoactividad",$limite);
		$this->view->tipoactividadList = $this->model->tipoactividadSingleList($id);
		$this->view->render("tipoactividad/copy");
	...
	//salida de datos como una tabla
        ...
        //header("location: " . URL . "tipoactividad/add");
}
public function editSave($id){
    ...
    header("location: " . URL . "tipoactividad");
}
	...
	public function roles($rol,$id,$opcion){
		switch($rol){
			case 1:
				...
				return "
				<a href=".URL."tipoactividad/copy/$id>
					<i class='fa fa-repeat'title=Copiar></i>
				</a>&nbsp;
				<a href=".URL."tipoactividad/view/$id>
					<i class='fa fa-eye'title=Ver ></i>
				</a>&nbsp;
				<a href=".URL."tipoactividad/edit/$id>
					<i class='fa fa-edit'title=Editar ></i>
				</a>&nbsp;
				<a href=".URL."tipoactividad/delete/$id  id=erase>
