<?php
class Procesador extends Controller {
	...
	$this->view->page=1;
	$limite="1000000";
	$this->view->totalList=$this->model->anyList("procesador",$limite);
	...
	$this->view->procesadorList = $this->model->procesadorList($start,NUM_ITEMS_BY_PAGE);
	$this->view->render("procesador/index");
	}
	...
	$this->view->procesadorList = $this->model->procesadorListUltimo();
	$this->view->render("procesador/index");
	}
	public function add(){
	$limite=10;
	$start=0;
	$this->view->anyList=$this->model->anyList("procesador",$limite);
	$this->view->procesadorList = $this->model->procesadorList($start,NUM_ITEMS_BY_PAGE);
	$this->view->procesadorListUltimo = $this->model->procesadorListUltimo();
	$this->view->render("procesador/add");
	}
	public function search(){
	$start=0;
	$this->view->page=1;
	$this->view->procesadorList = $this->model->procesadorSingleSearch($_POST["dato"],$_POST["criterio"]);
	$this->view->total_registros=count($this->view->procesadorList );
	$this->view->total_pages=ceil($this->view->total_registros/NUM_ITEMS_BY_PAGE);
	$this->view->render("procesador/index");
	}
	...
	$limite=10;
	$this->view->anyList=$this->model->anyList("procesador",$limite);
	$this->view->procesadorList = $this->model->procesadorSingleList($id);
	$this->view->render("procesador/view");
	}
    public function edit($id){
		$limite=10;
		$this->view->anyList=$this->model->anyList("procesador",$limite);
		$this->view->procesadorList = $this->model->procesadorSingleList($id);
		$this->view->render("procesador/edit");
	...
	public function copy($id){
		...
		$this->view->anyList=$this->model->anyList("procesador",$limite);
		$this->view->procesadorList = $this->model->procesadorSingleList($id);
		$this->view->render("procesador/copy");
	...
	//salida de datos como una tabla
        ...
        //header("location: " . URL . "procesador/add");
}
public function editSave($id){
    ...
    header("location: " . URL . "procesador");
}
	...
	public function roles($rol,$id,$opcion){
		switch($rol){
			case 1:
				...
				return "
				<a href=".URL."procesador/copy/$id>
					<i class='fa fa-repeat'title=Copiar></i>
				</a>&nbsp;
				<a href=".URL."procesador/view/$id>
					<i class='fa fa-eye'title=Ver ></i>
				</a>&nbsp;
				<a href=".URL."procesador/edit/$id>
					<i class='fa fa-edit'title=Editar ></i>
				</a>&nbsp;
				<a href=".URL."procesador/delete/$id  id=erase>
