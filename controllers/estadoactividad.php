<?php
class Estadoactividad extends Controller {
	...
	$this->view->page=1;
	$limite="1000000";
	$this->view->totalList=$this->model->anyList("estadoactividad",$limite);
	...
	$this->view->estadoactividadList = $this->model->estadoactividadList($start,NUM_ITEMS_BY_PAGE);
	$this->view->render("estadoactividad/index");
	}
	...
	$this->view->estadoactividadList = $this->model->estadoactividadListUltimo();
	$this->view->render("estadoactividad/index");
	}
	public function add(){
	$limite=10;
	$start=0;
	$this->view->anyList=$this->model->anyList("estadoactividad",$limite);
	$this->view->estadoactividadList = $this->model->estadoactividadList($start,NUM_ITEMS_BY_PAGE);
	$this->view->estadoactividadListUltimo = $this->model->estadoactividadListUltimo();
	$this->view->render("estadoactividad/add");
	}
	public function search(){
	$start=0;
	$this->view->page=1;
	$this->view->estadoactividadList = $this->model->estadoactividadSingleSearch($_POST["dato"],$_POST["criterio"]);
	$this->view->total_registros=count($this->view->estadoactividadList );
	$this->view->total_pages=ceil($this->view->total_registros/NUM_ITEMS_BY_PAGE);
	$this->view->render("estadoactividad/index");
	}
	...
	$limite=10;
	$this->view->anyList=$this->model->anyList("estadoactividad",$limite);
	$this->view->estadoactividadList = $this->model->estadoactividadSingleList($id);
	$this->view->render("estadoactividad/view");
	}
    public function edit($id){
		$limite=10;
		$this->view->anyList=$this->model->anyList("estadoactividad",$limite);
		$this->view->estadoactividadList = $this->model->estadoactividadSingleList($id);
		$this->view->render("estadoactividad/edit");
	...
	public function copy($id){
		...
		$this->view->anyList=$this->model->anyList("estadoactividad",$limite);
		$this->view->estadoactividadList = $this->model->estadoactividadSingleList($id);
		$this->view->render("estadoactividad/copy");
	...
	//salida de datos como una tabla
        ...
        //header("location: " . URL . "estadoactividad/add");
}
public function editSave($id){
    ...
    header("location: " . URL . "estadoactividad");
}
	...
	public function roles($rol,$id,$opcion){
		switch($rol){
			case 1:
				...
				return "
				<a href=".URL."estadoactividad/copy/$id>
					<i class='fa fa-repeat'title=Copiar></i>
				</a>&nbsp;
				<a href=".URL."estadoactividad/view/$id>
					<i class='fa fa-eye'title=Ver ></i>
				</a>&nbsp;
				<a href=".URL."estadoactividad/edit/$id>
					<i class='fa fa-edit'title=Editar ></i>
				</a>&nbsp;
				<a href=".URL."estadoactividad/delete/$id  id=erase>
