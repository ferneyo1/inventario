<?php
class Tipoequipos extends Controller {
	...
	$this->view->page=1;
	$limite="1000000";
	$this->view->totalList=$this->model->anyList("tipoequipos",$limite);
	...
	$this->view->tipoequiposList = $this->model->tipoequiposList($start,NUM_ITEMS_BY_PAGE);
	$this->view->render("tipoequipos/index");
	}
	...
	$this->view->tipoequiposList = $this->model->tipoequiposListUltimo();
	$this->view->render("tipoequipos/index");
	}
	public function add(){
	$limite=10;
	$start=0;
	$this->view->anyList=$this->model->anyList("tipoequipos",$limite);
	$this->view->tipoequiposList = $this->model->tipoequiposList($start,NUM_ITEMS_BY_PAGE);
	$this->view->tipoequiposListUltimo = $this->model->tipoequiposListUltimo();
	$this->view->render("tipoequipos/add");
	}
	public function search(){
	$start=0;
	$this->view->page=1;
	$this->view->tipoequiposList = $this->model->tipoequiposSingleSearch($_POST["dato"],$_POST["criterio"]);
	$this->view->total_registros=count($this->view->tipoequiposList );
	$this->view->total_pages=ceil($this->view->total_registros/NUM_ITEMS_BY_PAGE);
	$this->view->render("tipoequipos/index");
	}
	...
	$limite=10;
	$this->view->anyList=$this->model->anyList("tipoequipos",$limite);
	$this->view->tipoequiposList = $this->model->tipoequiposSingleList($id);
	$this->view->render("tipoequipos/view");
	}
    public function edit($id){
		$limite=10;
		$this->view->anyList=$this->model->anyList("tipoequipos",$limite);
		$this->view->tipoequiposList = $this->model->tipoequiposSingleList($id);
		$this->view->render("tipoequipos/edit");
	...
	public function copy($id){
		...
		$this->view->anyList=$this->model->anyList("tipoequipos",$limite);
		$this->view->tipoequiposList = $this->model->tipoequiposSingleList($id);
		$this->view->render("tipoequipos/copy");
	...
	//salida de datos como una tabla
        ...
        //header("location: " . URL . "tipoequipos/add");
}
public function editSave($id){
    ...
    header("location: " . URL . "tipoequipos");
}
	...
	public function roles($rol,$id,$opcion){
		switch($rol){
			case 1:
				...
				return "
				<a href=".URL."tipoequipos/copy/$id>
					<i class='fa fa-repeat'title=Copiar></i>
				</a>&nbsp;
				<a href=".URL."tipoequipos/view/$id>
					<i class='fa fa-eye'title=Ver ></i>
				</a>&nbsp;
				<a href=".URL."tipoequipos/edit/$id>
					<i class='fa fa-edit'title=Editar ></i>
				</a>&nbsp;
				<a href=".URL."tipoequipos/delete/$id  id=erase>
